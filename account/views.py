    ...
    def post(self, request):
        ...
        if user is not None:
            ...
            if not user.is_active:
                ...
                activation_url = f"{os.environ.get('FRONTEND_URL')}/account/activate/{uidb64}/{token}/"
...
class PasswordResetAPIView(APIView):
    ...
    def post(self, request):
        ...
        if user:
            ...
            frontend_reset_url = f"{os.environ.get('FRONTEND_URL')}/account/password-reset-confirm/{uidb64}/{token}/"
