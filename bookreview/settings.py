...
# SECRET_KEY = 'django-insecure-5hwluexbh+4ktfh%hnv)10q6!b5mtl=*l+=mq-e7lkz6psh4*)'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'The user can add the book and other user can comment regarding the book added',
    'VERSION': '1.0.0',
